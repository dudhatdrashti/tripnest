...
<Breadcrumb
          ...
          <p className="text-white/80 text-sm mb-4">
            {hotels.length} {t('search.results')}
          </p>
          ...
          <form onSubmit={handleSearch} className="relative max-w-2xl">
            <div className="relative">
              ...
              <button
                type="submit"
                className="absolute right-3 top-1/2 -translate-y-1/2 px-6 py-2 bg-gradient-to-r from-primary-500 to-accent-500 hover:from-primary-600 hover:to-accent-600 text-white font-medium rounded-xl transition-all duration-300 shadow-lg shadow-primary-500/30"
              >
                {t('common.search')}
              </button>
            </div>
