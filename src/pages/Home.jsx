...
const countLabels = {
  'Beach Resorts': 'ui.luxuryProperties',
  'Mountain Retreats': 'ui.exclusiveStays',
  'City Hotels': 'ui.premiumHotels',
  'Luxury Villas': 'ui.privateVillas',
  'Boutique Stays': 'ui.curatedStays',
  'Heritage Hotels': 'ui.heritagePalaces',
};
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        toast.error(t('ui.failedLoad', { item: t('ui.dataWord') }));
      }
    };
    fetchData();
  }, []);
...
{/* Image — always visible, subtle zoom + brightness lift on hover */}
                  ...
                  <div className="absolute inset-x-0 bottom-0 z-10 p-5 sm:p-6">
                    ...
                    <p className="text-white/70 text-xs sm:text-sm mt-1 font-light">
                      {cat.count}+ {t(countLabels[cat.name] || 'ui.properties')}
                    </p>
...
{/* Popular Destinations */}
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {[
              { value: '50+', label: 'ui.destinations' },
              { value: '10K+', label: 'ui.travelers' },
              { value: '4.9', label: 'ui.averageRating' },
            ].map((statItem, idx) => (
              <div
                key={idx}
              ...
              >
                ...
                <span className="text-sm text-gray-500 dark:text-gray-400">                {t(statItem.label)}</span>
                {idx < 2 && (
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400">{t('ui.exclusiveDeals')}</p>
          </motion.div>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400">{t('ui.realStories')}</p>
          </motion.div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            >
              ...
              <p className="text-white/80">{t('ui.happyTravelers')}</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <p className="text-white/80">{t('ui.hotelsWorldwide')}</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="text-center text-white"
            >
              <div className="text-5xl md:text-6xl font-bold mb-2">190+</div>
              <p className="text-white/80">{t('ui.destinations')}</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
...
<div className="text-5xl md:text-6xl font-bold mb-2">10+</div>
              <p className="text-white/80">{t('ui.yearsExcellence')}</p>
            </motion.div>
          </div>
        </div>
      </section>
